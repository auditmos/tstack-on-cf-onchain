...
import { AlertCircle, CheckCircle, Code2, Loader2, Play, Server, Zap } from "lucide-react";
								...
								<div className="space-y-6">
									...
									<div className="pt-4 border-t border-border">
										<Alert>
											...
											<AlertDescription>
												<strong>Check your server logs!</strong> You'll see console output from both
												the middleware and server function execution.
											</AlertDescription>
										</Alert>
									</div>
