		...
		<section className="relative px-6 lg:px-8 py-24 sm:py-32">
			<div className="mx-auto max-w-4xl text-center">
				...
				<p className="mt-6 text-lg leading-8 text-muted-foreground max-w-2xl mx-auto">
					A modern, type-safe, full-stack React framework combining the power of TanStack Router and
					Query with the latest web technologies. Start building production-ready applications
					today.
				</p>
